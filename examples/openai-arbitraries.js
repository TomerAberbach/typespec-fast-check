...
export const OpenAI = {
  ...
  CreateChatCompletionRequest: fc
    .tuple(
      fc.record(
        {
          /**
      ...
      fc.record(
        {
          ...
          suffix: fc.option(fc.option(fc.string())),
          /**
           ...
           */
          logprobs: fc.option(fc.option(fc.maxSafeInteger())),
  ...
  CreateFineTuningJobRequest: fc.record(
    {
       ...
       */
      suffix: fc.option(fc.option(SuffixString)),
    },
    {
  ...
  CreateFineTuneRequest: fc.record(
    {
      ...
      model: fc.oneof(
        fc.string(),
        fc.option(fc.constantFrom("ada", "babbage", "curie", "davinci")),
      ),
      /**
       * The number of epochs to train the model for. An epoch refers to one full cycle through the
       * training dataset.
      ...
      fc.record(
        {
          ...
          size: fc.oneof(
            fc.option(fc.constantFrom("256x256", "512x512", "1024x1024")),
  ...
  CreateImageVariationRequest: fc
    .tuple(
      fc.record(
        {
          /** The number of images to generate. Must be between 1 and 10. */
